...
public class JavaZonApp 
{
    ...
    public static void main(String[] args) 
    {
        ...
        String street = Validator.getValidStreet(JOptionPane.showInputDialog("Enter Street Name"));
        String city = Validator.getValidCity(JOptionPane.showInputDialog("Enter City Name"));
        String state = Validator.getValidState(JOptionPane.showInputDialog("Enter State Name"));
        String zip = Validator.getValidZip(JOptionPane.showInputDialog("Enter ZipCode"));
